...
echo "<H1><i>Reporte: Tiempo 0 - Orientaci&oacute;n a la carrera</i></H1>";
...
echo "<table id='tabla_reporte' align='center' width='100%'>";//width='100%' 
			...
			echo "<thead><tr>";		
				...
				foreach($array_formularios as $form_valor){
					...
					if($form_valor['id']==1 or $form_valor['id']==2 or $form_valor['id']==25 or $form_valor['id']==28){
						echo "<th>".$form_valor['descripcion']."</th>";
						$cant_forms++;
				...
				echo "<th >V&iacute;a en que se inform&oacute;</th>";
				echo "<th >Motivo de elecci&oacute;n de la carrera</th>";
				echo "<th >Motivo de elecci&oacute;n FRGP</th>";
				echo "<th >Sabe que carrera va a estudiar</th>";
				echo "<th >Descontinuidad</th>";
				echo "<th >Causas</th>";
			echo "</tr></thead><tbody>";
			...
			foreach($alumnos_mutantes as $mutar)
			{
				...
				echo "<tr>";
					...
					//MCO modificado
						...
						if($_REQUEST['salida']!='Excel')  echo "<ol>"; //corbi20160627
						foreach($respuestas as $singleresponse)
							if($singleresponse['texto']!="OTRA (ESPECIFICAR)") echo $vineta.$singleresponse['texto'].$vineta2;
						if($_REQUEST['salida']!='Excel') echo "</ol>"; //corbi20160627
					echo "</td>";	
					...
					echo "<td bgcolor='".$color_fondo."'>";
						...
						foreach($motivo_carrera as $singleresponse)
							if(is_numeric(trim($singleresponse['valor']))){ 
								...
								if(strtoupper($motivo[0][0]) != "OTRA (ESPECIFICAR)" ) echo $vineta.$motivo[0][0].$vineta2;
							} 
							else
								if($singleresponse['valor'] != "OTRA (ESPECIFICAR)") echo $vineta.$singleresponse['valor'].$vineta2;
					//2  64   142   135
						if($_REQUEST['salida']!='Excel') echo "</ol>"; //corbi20160627
	...
	<table class="table" width='50%' align='center' valign='top'>
	<tr>
	...
	<td align='center'>
		<table class='table table-bordered table-striped' width='80%' cellpadding='2' cellspacing='2'>
		<tr>
