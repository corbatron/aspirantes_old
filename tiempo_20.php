...
echo "<H1><i>Reporte: Tiempo 2 - 1ra Percepci&oacute;n de autorregulaci&oacute;n (Metas y planificaci&oacute;n)</i></H1>";
...
echo "<table id='tabla_reporte' align='center' width='100%'>";//width='100%' 
		...
		echo "<td >";//width='50%'
			...
			echo "<thead><tr>";		
				...
				echo "<th>Tipo de entrevista</th>";	
				echo "<th>Fecha 1er entrevista</th>";
				echo "<th>Riesgo</th>";			
				echo "<th>Acuerdos logrados</th>";
				echo "<th>Tutor</th>";
